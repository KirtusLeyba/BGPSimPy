...
\begin{abstract}
 The structure, growth,and societal impact of the Internet topology at the Autonomous System (AS) level 
 have been scrutinized for several decades. 
...
% nations to intercept or control BGP routing paths or how the Internet 
 ...
 that have strengthened border chokepoints.  Additionally,
 we find that a significant relationship exists between CP and
 Internet freedom as evaluated by two qualitative sources.
\end{abstract}
