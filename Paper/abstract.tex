...
% nations to intercept or control BGP routing paths or how the Internet 
 % topology could facilitate censorship and surveillance.  We
 introduce a new measure, \emph{chokepoint potential} (CP), to
 ...
 that rely on a shrinking number of Autonomous Systems.  Additionally,
