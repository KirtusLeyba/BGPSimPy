...
\begin{abstract}
 ...
 nations to intercept BGP routing paths or how the Internet 
 topology could facilitate censorship and surveillance. We introduce a new measure, \emph{national breakthrough
 potential},\Ben[inline]{I like chokepoint} or NBP, to characterize how a country's AS topology is organized in terms of paths that can carry 
 traffic across international borders.  To study country-level chokepoints, we developed \toolname{}, an open source,
 cross platform, efficient tool for simulating BGP routing and monitoring national chokepoints. 
 We find that for many nations the continuous growth of the AS graph is not reflected by more open
