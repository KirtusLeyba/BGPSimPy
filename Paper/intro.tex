...
for studying worldwide Internet architecture over time.  Current
methods have primarily focused on the node level (individual ASes)
rather than the country level\Steph[inline]{Josh Karlin and Jen Rexford papers are two exceptions},
